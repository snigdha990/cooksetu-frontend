...
import { CurrencyDollarIcon, CalendarIcon, StarIcon } from "@heroicons/react/24/outline";

const businessModels = [
  {
    title: "Transaction Commission",
    description:
      "Earn sustainable revenue with a 15% commission on every cook-user booking transaction.",
  ...
  },
  {
    ...
    description:
      "Monthly subscription plans offer discounted rates and priority bookings to drive recurring revenue and customer loyalty.",
    icon: CalendarIcon,
  ...
  },
  {
    ...
    description:
      "Generate extra revenue through premium cook profiles, featured listings, and strategic advertising partnerships.",
    icon: StarIcon,
...
export default function BusinessModel() {
  return (
    ...
    >
      ...
      >
        {businessModels.map(({ title, description, icon: Icon, gradient }) => (
          <motion.div
            key={title}
